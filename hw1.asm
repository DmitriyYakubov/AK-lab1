...
DATASEG
exCode db 0
yakubov db "yakubov",10,13,'$';Рядок символів для виводу на екран
luchyk db "luchyk",10,13,'$';Рядок символів для виводу на екран
tajibayev db "tajibayev",10,13,'$';Рядок символів для виводу на екран
...
;--------------------------------- 1. Ініціалізація DS и ES---------------------------------------
	...
	mov cx,5        ; лічильник повторень циклу
